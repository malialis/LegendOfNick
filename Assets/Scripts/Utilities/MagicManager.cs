...
public class MagicManager : MonoBehaviour
{
    ...
    public void AddMagic(float ammountToAdd)
    {
        magicSlider.value += ammountToAdd;
        playerInventory.currentMagic += ammountToAdd;
    ...
    public void DecreaseMagic(float ammountToDecrease)
    {
       // magicSlider.value -= ammountToDecrease;
        // playerInventory.currentMagic -= ammountToDecrease;
